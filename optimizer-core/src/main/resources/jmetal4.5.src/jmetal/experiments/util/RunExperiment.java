		...
		while(!finished){
			...
			if(!finished && problemData != null){
				...
				try {
                  ...
                  // Result messages
//                log.info("Execution time= " + (((estimatedTime)) / 1000.0) + " seconds");
                  System.out.print("Execution time= " + (((estimatedTime)) / 1000.0) + " seconds\t");
				...
				resultFront.printObjectivesToFile(directory + "/" + outputParetoFrontFile_ + "_" + runs);
				resultFront.printVariablesToFile(directory + "/" + outputParetoSetFile_ + "_" + runs);
				if(!finished){
