 ...
 */
public class WorstSolution extends Selection {
  
   // Comparator
  private Comparator comparator_;
    
  public WorstSolution(HashMap<String, Object> parameters) {
  super(parameters) ;
...
//    return worstSolution ;
    return solutionSet.get(worstSolution) ; //Modified by Stefano Terragni
  } // Execute     
