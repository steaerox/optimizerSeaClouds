 ...
 */
public class BestSolution extends Selection {
  
   // Comparator
  private Comparator comparator_;
    
  public BestSolution(HashMap<String, Object> parameters) {
     super(parameters) ;
...
//    return bestSolution ;
    return solutionSet.get(bestSolution) ; //Modified by Stefano Terragni
  } // Execute     
