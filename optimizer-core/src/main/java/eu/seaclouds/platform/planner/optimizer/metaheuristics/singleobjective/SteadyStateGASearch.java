...
public class SteadyStateGASearch extends MetaHeuristic {

   static Logger log = LoggerFactory.getLogger(SteadyStateGASearch.class);
   ...
   public static class Builder extends MetaHeuristic.Builder<Builder> {
      ...
      public SteadyStateGASearch build() throws JMException {
         return new SteadyStateGASearch(this);
      }
   }

   public SteadyStateGASearch(Builder builder) throws JMException {
      super(builder);
