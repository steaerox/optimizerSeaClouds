...
/**
 * This class implements a Random mutation of one of each Variable (Performance, Availability, Cost) in a probabilistic manner.
 * The solution type of the solution must be SeaClouds.
 */
public class BestInAllPACandNumOfInstancesMutation extends Mutation {
    /**
     ...
     * Constructor
     */
    public BestInAllPACandNumOfInstancesMutation(HashMap<String, Object> parameters) {
        super(parameters);
...
//
//                        while (numOfInstances == ((Modules) solution
//                                .getDecisionVariables()[0]).getModuleList()
//                                .get(i).getNumOfInstancesForBestCloudOffer()) {
//                            numOfInstances = PseudoRandom
//                                    .randInt(
//                                            1,
//                                            ((Modules) solution
//                                                    .getDecisionVariables()[0])
...
//
//                        ((Modules) solution.getDecisionVariables()[0])
//                                .getModuleList().get(i).setBestCloudOfferBetweenPACequallyRandom();
//
//                        
            ...
            ((Modules) solution.getDecisionVariables()[0]).computeConstraints(((Modules) solution.getDecisionVariables()[0]).getConstraints().length);
               ...
               Configuration.logger_
                       .severe("PACandNumOfInstancesMutation.doMutation: invalid type. "
                               + ""
