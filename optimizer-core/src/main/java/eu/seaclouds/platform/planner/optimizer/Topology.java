...
//        this.moduleList = new ArrayList<Module>(m.moduleList);
//        top.modules = this.modules;
//        
//        return top;
    ...
    public TopologyElement getInitialElement() {
        ...
        for (TopologyElement pointed : modules) {
            ...
            // Check if any of the elements in the topology depends on (calls)
            // it
