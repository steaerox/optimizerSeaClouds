...
public class QualityInformation implements Cloneable{
   ...
   @Override
   public QualityInformation clone() throws CloneNotSupportedException {
      return (QualityInformation) super.clone();
   }
