...
public class GenerationalGASearch extends MetaHeuristic {

   static Logger log = LoggerFactory.getLogger(GenerationalGASearch.class);
   ...
   public static class Builder extends MetaHeuristic.Builder<Builder> {
      ...
      public GenerationalGASearch build() throws JMException {
         return new GenerationalGASearch(this);
      }
   }

   public GenerationalGASearch(Builder builder) throws JMException {
      super(builder);
      ...
      this.algorithm = new gGA(this.problem);
