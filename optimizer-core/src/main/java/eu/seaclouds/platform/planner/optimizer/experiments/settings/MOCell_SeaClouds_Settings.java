 ...
 */
public class MOCell_SeaClouds_Settings extends Settings {
    ...
    * @param metaHeuristic
    */
   public MOCell_SeaClouds_Settings(String problem, Object[] problemParams,
   ...
   public Algorithm configure(Properties configuration) throws JMException {
      ...
      // Selecting the algorithm: there are six MOCell variants (to test)
      ...
      feedback_ = Integer.parseInt(configuration.getProperty("feedback",
            String.valueOf(feedback_)));
