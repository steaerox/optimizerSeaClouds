...
public class NonElitistESSearch extends MetaHeuristic {
   ...
   public static class Builder extends MetaHeuristic.Builder<Builder> {
      ...
      public NonElitistESSearch build() throws JMException {
         return new NonElitistESSearch(this);
      }
   }

   public NonElitistESSearch(Builder builder) throws JMException {
      super(builder);
      ...
      this.algorithm = new NonElitistES(problem, mu, lambda);
