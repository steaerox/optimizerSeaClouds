...
public class YAMLmodulesOptimizerParserNew {

   static Logger log = LoggerFactory
                           .getLogger(YAMLmodulesOptimizerParserNew.class);
...
//   public static String getTypeOfModule(Object module, Map<String, Object> moduleMap) {
//      
//      Map<String, Object> currentModule = (Map<String, Object>) module;
//      
//      Map<String, Object> typeOfModule = (Map<String, Object>) currentModule.get(TOSCAkeywords.MODULE_REQUIREMENTS_HOST);
//    String valueOfType = "";
//    if (typeOfOffer.containsKey(cloudOfferType)) {
//        valueOfType = (String) typeOfOffer.get(cloudOfferType);
//    } else {
//            log.error("CloudOffer type not found");
//    }
//    return valueOfType;
//}
