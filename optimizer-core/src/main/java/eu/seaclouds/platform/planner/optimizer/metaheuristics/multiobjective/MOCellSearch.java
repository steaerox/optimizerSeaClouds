...
public class MOCellSearch extends MetaHeuristic {

   static Logger log = LoggerFactory.getLogger(MOCellSearch.class);
   ...
   public static class Builder extends MetaHeuristic.Builder<Builder> {
      ...
      public MOCellSearch build() throws JMException {
         return new MOCellSearch(this);
      }
   }

   public MOCellSearch(Builder builder) throws JMException {
      super(builder);
      ...
      this.algorithm = new MOCell(this.problem);
