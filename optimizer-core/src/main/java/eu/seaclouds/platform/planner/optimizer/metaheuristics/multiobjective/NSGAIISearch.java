...
public class NSGAIISearch extends MetaHeuristic {

   static Logger log = LoggerFactory.getLogger(NSGAIISearch.class);
   ...
   public static class Builder extends MetaHeuristic.Builder<Builder> {
      ...
      public NSGAIISearch build() throws JMException {
         return new NSGAIISearch(this);
      }
   }

   public NSGAIISearch(Builder builder) throws JMException {
      super(builder);
      ...
      this.algorithm = new NSGAII(this.problem);
