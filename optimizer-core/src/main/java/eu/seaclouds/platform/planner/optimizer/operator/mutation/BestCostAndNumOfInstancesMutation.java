 ...
 */
public class BestCostAndNumOfInstancesMutation extends Mutation {
    /**
     ...
     * Constructor
     */
    public BestCostAndNumOfInstancesMutation(HashMap<String, Object> parameters) {
        super(parameters);
...
//                                .getModuleList().get(i).setBestCostCloudOffer();
            ...
            // ((Module)
            // solution.getDecisionVariables()[i]).setBestCostCloudOffer();
            // } // if
            // }
            // }
