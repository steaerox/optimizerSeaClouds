...
public class SynchronousCellularGASearch extends MetaHeuristic {

   static Logger log = LoggerFactory.getLogger(SynchronousCellularGASearch.class);

   public static class Builder extends MetaHeuristic.Builder<Builder> {
      
      private int populationSize = 400; //NxN: 20x20
      ...
      public SynchronousCellularGASearch build() throws JMException {
         return new SynchronousCellularGASearch(this);
      }
   }

   public SynchronousCellularGASearch(Builder builder) throws JMException {
      super(builder);
      ...
      this.algorithm = new scGA(this.problem);
